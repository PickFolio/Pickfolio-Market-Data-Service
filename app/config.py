...
STOCK_HISTORY_INCREMENTAL_ON_STARTUP = (
    os.environ.get("STOCK_HISTORY_INCREMENTAL_ON_STARTUP", "false").lower() == "true"
)
STOCK_HISTORY_INCREMENTAL_SCHEDULER_ENABLED = (
    os.environ.get("STOCK_HISTORY_INCREMENTAL_SCHEDULER_ENABLED", "true").lower() == "true"
)
STOCK_HISTORY_INCREMENTAL_DELAY_SEC = float(os.environ.get("STOCK_HISTORY_INCREMENTAL_DELAY_SEC", "0.5"))
STOCK_HISTORY_INCREMENTAL_LOOKBACK_DAYS = int(os.environ.get("STOCK_HISTORY_INCREMENTAL_LOOKBACK_DAYS", "10"))
STOCK_HISTORY_INCREMENTAL_RUN_HOUR_IST = int(os.environ.get("STOCK_HISTORY_INCREMENTAL_RUN_HOUR_IST", "3"))
STOCK_HISTORY_INCREMENTAL_RUN_MINUTE_IST = int(os.environ.get("STOCK_HISTORY_INCREMENTAL_RUN_MINUTE_IST", "0"))
STOCK_HISTORY_INCREMENTAL_STARTUP_LIMIT = os.environ.get("STOCK_HISTORY_INCREMENTAL_STARTUP_LIMIT")
